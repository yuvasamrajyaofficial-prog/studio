      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-12 md:mb-16 text-center md:text-left">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm text-muted-foreground font-body">
              ...
              <li><Link href="/cosmos" className="hover:text-primary transition-colors">Your Cosmos</Link></li>
            </ul>
          </div>

          {/* Column 2: About */}
          <div className="space-y-4">
            <h3 className="font-headline text-lg font-bold text-primary mb-4">About</h3>
            <ul className="space-y-3 text-sm text-muted-foreground font-body">
              <li><Link href="/about" className="hover:text-primary transition-colors">About MALOLA</Link></li>
              <li><Link href="/contact" className="hover:text-primary transition-colors">Contact Us</Link></li>
              <li><Link href="/legal/ethical-ai" className="hover:text-primary transition-colors">Ethical AI Policy</Link></li>
              <li><Link href="/legal/community-guidelines" className="hover:text-primary transition-colors">Community Guidelines</Link></li>
            </ul>
          </div>

          {/* Column 3: Legal */}
          <div className="space-y-4">
            <h3 className="font-headline text-lg font-bold text-primary mb-4">Legal</h3>
            <ul className="space-y-3 text-sm text-muted-foreground font-body">
              ...
              <li><Link href="/legal/dmca" className="hover:text-primary transition-colors">DMCA / Copyright</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center justify-center space-y-6 border-t border-border/30 pt-8">
          ...
          <div className="text-center text-xs text-muted-foreground/60 font-body">
            <p>© 2026 MALOLA. All Rights Reserved.</p>
