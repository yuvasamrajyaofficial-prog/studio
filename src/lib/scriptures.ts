...
export type Scripture = {
  ...
  // The old 'content' field is now replaced by 'description' and 'chapters'
  content: string; // Keep for now to avoid breaking components, will be removed.
  roadmap?: string[];
};
...
export const scriptures: Scripture[] = [
  // 1. SHRUTI – VEDAS (Timeless)
  {
    ...
    category: 'Vedas',
    yuga: 'Timeless',
    description: 'The Rig Veda is the oldest and most important of the four Vedas, a foundational scripture of Sanatana Dharma. It is a vast collection of 1,028 hymns (sūktas) and 10,600 verses, organized into ten books (maṇḍalas).',
