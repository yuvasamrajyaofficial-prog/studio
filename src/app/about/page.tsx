...
export default function AboutPage() {
  return (
    ...
    >
      <div className="max-w-4xl mx-auto space-y-8 text-slate-300 leading-relaxed p-6">
        ...
        <section className="bg-white/5 p-8 rounded-2xl border border-white/10 backdrop-blur-sm">
          <h2 className="text-2xl font-bold text-blue-400 mb-4">Technology Meets Tradition</h2>
          <p>
        ...
        <section className="bg-white/5 p-8 rounded-2xl border border-white/10 backdrop-blur-sm">
          <h2 className="text-2xl font-bold text-purple-400 mb-4">The Name "Malola"</h2>
          <p>
