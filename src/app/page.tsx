    ...
    <>
      <JsonLd
        ...
        data={{
          name: "MALOLA",
          description:
            "Navigate the vast universe of ancient scriptures with an interactive guide",
        }}
      />
      ...
      <div className="min-h-screen flex flex-col bg-background selection:bg-primary/20">
        ...
        <main className="flex-1 pt-16">
          {/* Hero Section */}
          <section className="relative min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center overflow-hidden py-12 md:py-0">
            {/* Background Effects */}
            ...
            <div className="container mx-auto px-4 relative z-10 flex flex-col items-center text-center">
              ...
              <h1 className="font-headline text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 text-foreground leading-tight">
              ...
              <p className="max-w-2xl text-base md:text-lg text-muted-foreground mb-10 leading-relaxed font-light px-4 font-body">
                Explore ancient scriptures, divine wisdom, and educational
                resources through a culture-aware, ethically governed AI
                platform.
              </p>
              ...
              <div className="flex flex-col items-center gap-4">
                {user ? (
                  <Button
                    asChild
                    size="lg"
                    className="bg-primary hover:bg-primary/90 text-primary-foreground font-bold h-10 px-6 text-base md:h-14 md:px-10 md:text-lg shadow-lg shadow-primary/30"
                  >
            ...
            <div className="container mx-auto px-4">
              <div className="text-center max-w-3xl mx-auto mb-16">
                ...
                <p className="text-muted-foreground text-lg font-body">
                  A unified ecosystem designed to preserve, translate, and make
                  accessible the world's profound spiritual heritage.
                </p>
              </div>
